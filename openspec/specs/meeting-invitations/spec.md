# meeting-invitations Specification

## Purpose
Define how meeting invitations are detected from email, shown in the message reader, and answered with calendar RSVP semantics.
